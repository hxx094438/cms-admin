          ...
          <el-col :span="24" key="1" v-if="$route.path !== '/home'" class="breadcrumb">
            <el-breadcrumb>
              <transition-group tag="div" name="btn" class="el-breadcrumb">
                ...
                >{{ currentPathNameParent }}</el-breadcrumb-item>
                <el-breadcrumb-item
...
export default {
  data() {
    return {
      ...
      user: {
        gravatar: 'https://avatars3.githubusercontent.com/u/30933912?s=40&v=4'
      }
    }
  },

  created() {
    console.log('router.options',this.$router.options)
  },
